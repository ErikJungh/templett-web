...
export class HeroComponent  {
 ...
 slideshowSwitch(slideshow: JQuery<HTMLElement>,index : number,auto: boolean) : void{
  ...
  if(transition=='fade'){
    ...
    var slideWidth = slideshow.width() || 1
    if(newSlide.index()>activeSlide.index() && slideshow.width !== undefined){
      var newSlideRight:any=0;
      var newSlideLeft:any='auto';
      var newSlideImageRight:any= -slideWidth/8;
      ...
      var activeSlideImageLeft:any=-slideWidth/4;
    } else {
      var newSlideRight:any='';
      var newSlideLeft:any=0;
      var newSlideImageRight:any='auto';
      var newSlideImageLeft:any=-slideWidth/8;
 ...
 slideshowNext(slideshow: JQuery<HTMLElement>,previous,auto):void{
  var slides=slideshow.find('.slide');
  var activeSlide=slides.filter('.is-active');
  var newSlide=null;
  if(previous){
